...
namespace Masfernandez\ArticleFeature\Tests\Application\Article\Create\CreateWithRepository;

use Masfernandez\ArticleFeature\Application\Article\Create\CreateWithRepository\ArticleCreator;
...
class ArticleCreatorTest extends TestCase
{
    ...
    public function itShouldCreateAnAlbum(): void
    {
        ...
        $articleRepository
            ->shouldReceive('countBy')
            ->with(['name' => $command->getName()])
            ->andReturns(0);
